      ...
      <React.Fragment>
        ...
        <Table size="small">
          <TableHead>
            <TableRow>
              <TableCell>
                <Trans>freezer.products.table.header.name</Trans>
              </TableCell>
              <TableCell>
                <Trans>freezer.products.table.header.freezeDate</Trans>
              </TableCell>
              <TableCell>
                <Trans>freezer.products.table.header.bestBefore</Trans>
              </TableCell>
              <TableCell>
                <Trans>freezer.products.table.header.type</Trans>
              </TableCell>
              <TableCell align="right">
                <Trans>freezer.products.table.header.quantity</Trans>
              </TableCell>
              <TableCell>
                <Trans>freezer.products.table.header.freezerLocation</Trans>
              </TableCell>
              <TableCell>
                <Trans>freezer.products.table.header.compartment</Trans>
              </TableCell>
              <TableCell>
                <Trans>freezer.products.table.header.notes</Trans>
              </TableCell>
              <TableCell></TableCell>
            </TableRow>
          </TableHead>
              ...
              <TableRow key={product._id}>
                ...
                <TableCell>
                  <IconButton
                    aria-label="edit"
                    size="small"
                    onClick={this.props.editProduct.bind(this, product)}
                  >
                    <EditIcon />
                  </IconButton>
                  <IconButton
